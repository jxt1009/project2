...
public class Track implements model.Track {
	 ...
	 * 
	 * @param ort
	 *            the track's orientation, either horizontal or vertical
	 * @param route
	 *            the route this piece of track belongs to
	 * @param row
	 *            the row this track is at
	 * @param col
	 *            the column this track is at
	 */
	 ...
	 * 
	 * @param owner
	 *            the non UNCLAIMED owner of the track
	 */
